...
export const DeveloperRegister = () => {
  ...
  return (
    <div className="glass-panel animate-fade-in" style={{ maxWidth: '400px', margin: '2rem auto' }}>
      <h3 style={{ textAlign: 'center', marginBottom: '1.5rem' }}>Developer Registration</h3>
      ...
      <form onSubmit={onSubmit}>
        ...
        <button className="btn" type="submit" style={{ marginTop: '1rem' }}>Register as Developer</button>
      </form>
      <div style={{ textAlign: 'center', marginTop: '1.5rem', fontSize: '0.9rem', color: 'var(--text-secondary)' }}>
        Already have an account? <Link to="/dev-login" style={{ color: 'var(--accent-primary)', textDecoration: 'none' }}>Login here</Link>
      </div>
    </div>
  );
};
